      ...
      <div className="text-center space-y-6 px-4">
        ...
        <div className="space-y-3">
          <button
            ...
            className="inline-flex items-center gap-3 bg-white hover:bg-gray-100 active:bg-gray-200 text-gray-800 font-semibold px-8 py-3 rounded-lg transition-colors w-full justify-center shadow"
          >
