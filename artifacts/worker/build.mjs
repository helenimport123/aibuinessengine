...
async function buildAll() {
  ...
  await esbuild({
    ...
    external: [
      ...
      "fsevents", "re2", "pg-native", "oracledb", "dtrace-provider", "isolated-vm",
      "lightningcss", "nodemailer", "knex", "typeorm", "protobufjs",
      ...
      "hiredis", "kerberos", "leveldown", "miniflare", "mysql2", "newrelic",
      "odbc", "piscina", "realm", "rocksdb", "sequelize", "serialport",
      "snappy", "tinypool", "usb", "workerd", "wrangler", "zeromq",
      "playwright", "puppeteer", "puppeteer-core",
    ],
    sourcemap: "linked",
